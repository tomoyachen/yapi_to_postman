...
HTTP = "https"
URL = "test-cwshenpi.hfjy.com"
YAPI_KEYWORDS = "izj-hfjy"
FILE_PATH = "E:\\Desktop"
...
#搜索项目名后进行遍历
api_group_list = controller.get_search_project(YAPI_KEYWORDS)
if len(api_group_list) > 1:
    ...
    for api_group_key, api_group_value in api_group_list.items():
        ...
        for api_key, api_value in api_list.items():
            ...
            api = controller.api_to_dict(HTTP = HTTP, URL = URL, API_INFO = api_info)
